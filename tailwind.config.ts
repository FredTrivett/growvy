...
const config: Config = {
	...
	theme: {
		extend: {
			backgroundImage: {
				'back-gradient': 'linear-gradient(90deg, rgba(103, 115, 253) 0%, rgba(145, 72, 227) 50%, rgba(103, 115, 253) 100%)',
				'text-gradient': 'linear-gradient(133deg, #A251FF 7.24%, #5081FE 127.1%)',
			},
			colors: {
